...
const sendAppointmentNotifications = async () => {
    ...
    for (const appointment of upcomingAppointments) {
        ...
        const text = `Dear ${appointment.PatientName},\n\nThis is a reminder that your appointment is scheduled for tomorrow with Dr. ${appointment.DoctorName} at ${appointment.ClinicName}, scheduled for ${moment(appointment.AppointmentDate).format('MMMM Do YYYY, h:mm:ss a')}.\nPlease be on time.\n\nBest regards,\n${appointment.ClinicName} Clinic`;
        appointment.PatientEmail = "long@gmail.com";
        try {
